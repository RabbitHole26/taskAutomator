...
if [ -f "package.json" ]; then
  ...
  sed -i.bak 's/"dev": "vite",/"dev": "vite --host --open $BROWSER",/' package.json && rm package.json.bak
  echo
...
if file_exists "./index.html"; then
  # Replace everything between <head> and </head> with the new template
  perl -i.bak -0777 -pe 's|<head>.*?</head>|<head>\n  <!-- ========================================================= -->\n  <!-- BASIC DOCUMENT SETUP                                      -->\n  <!-- ========================================================= -->\n\n  <!-- Character encoding -->\n  <meta charset="UTF-8" \/>\n\n  <!-- Responsive layout on mobile devices -->\n  <meta name="viewport" content="width=device-width, initial-scale=1.0" \/>\n\n  <!-- Page title (used by browsers and search engines) -->\n  <title>[PLACEHOLDER]<\/title> <!-- TODO -->\n\n  <!-- Short page description for search results -->\n  <meta name="description" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Canonical URL (prevents duplicate-content issues when the page can be accessed by more than one link) -->\n  <link rel="canonical" href="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- ========================================================= -->\n  <!-- SEARCH ENGINE DIRECTIVES (OPTIONAL)                       -->\n  <!-- ========================================================= -->\n\n  <!-- Allow indexing (default, only needed if you sometimes use noindex) -->\n  <meta name="robots" content="index,follow" \/>\n\n  <!-- ========================================================= -->\n  <!-- OPEN GRAPH (FACEBOOK, SLACK, DISCORD, WHATSAPP, IG)       -->\n  <!-- ========================================================= -->\n\n  <!-- Content type -->\n  <meta property="og:type" content="website" \/>\n\n  <!-- Website name -->\n  <meta property="og:site_name" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Title shown in link previews -->\n  <meta property="og:title" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Description shown in link previews -->\n  <meta property="og:description" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Canonical page URL -->\n  <meta property="og:url" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Preview image (ABSOLUTE URL REQUIRED) -->\n  <!-- Recommended size: 1200x630, JPG or PNG, < 5MB -->\n  <meta property="og:image" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Image dimensions (improves preview reliability) -->\n  <meta property="og:image:width" content="1200" \/>\n  <meta property="og:image:height" content="630" \/>\n\n  <!-- Accessibility text for the preview image -->\n  <meta property="og:image:alt" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- ========================================================= -->\n  <!-- TWITTER \/ X                                               -->\n  <!-- ========================================================= -->\n\n  <!-- Large preview card -->\n  <meta name="twitter:card" content="summary_large_image" \/>\n\n  <!-- Title for Twitter preview -->\n  <meta name="twitter:title" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Description for Twitter preview -->\n  <meta name="twitter:description" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Preview image for Twitter (can reuse OG image) -->\n  <meta name="twitter:image" content="[PLACEHOLDER]" \/> <!-- TODO -->\n\n  <!-- Optional: site account -->\n  <!-- <meta name="twitter:site" content="@yourhandle" \/> -->\n\n  <!-- ========================================================= -->\n  <!-- FAVICONS \/ APP ICONS                                      -->\n  <!-- ========================================================= -->\n\n  <!-- Standard favicon (ICO) -->\n  <link rel="icon" href="[PLACEHOLDER]" sizes="any"> <!-- TODO -->\n  <!-- Recommended sizes inside .ico: 16x16 (browser tab), 32x32 (high-res\/tab retina), 48x48 (desktop shortcuts\/legacy) -->\n\n  <!-- SVG favicon for modern browsers -->\n  <link rel="icon" type="image\/svg+xml" href="[PLACEHOLDER]"> <!-- TODO -->\n  <!-- SVG is scalable; ensure it is square and legible at small sizes like 16x16 -->\n\n  <!-- PNG favicons for legacy support -->\n  <link rel="icon" type="image\/png" sizes="16x16" href="[PLACEHOLDER]"> <!-- TODO -->\n  <!-- Standard browser tab\/favicon -->\n  <link rel="icon" type="image\/png" sizes="32x32" href="[PLACEHOLDER]"> <!-- TODO -->\n  <!-- High-resolution\/tab retina -->\n\n  <!-- Apple Touch Icons -->\n  <link rel="apple-touch-icon" sizes="180x180" href="[PLACEHOLDER]"> <!-- TODO -->\n  <!-- Standard iPhone\/iPad Retina -->\n  <link rel="apple-touch-icon" sizes="152x152" href="[PLACEHOLDER]"> <!-- TODO: DONE -->\n  <!-- iPad Retina -->\n  <link rel="apple-touch-icon" sizes="167x167" href="[PLACEHOLDER]"> <!-- TODO: DONE -->\n  <!-- iPad Pro -->\n  <link rel="apple-touch-icon" sizes="120x120" href="[PLACEHOLDER]"> <!-- TODO: DONE -->\n  <!-- Older iPhones -->\n\n  <!-- Android \/ PWA Icons -->\n  <link rel="icon" type="image\/png" sizes="192x192" href="[PLACEHOLDER]"> <!-- TODO: DONE -->\n  <!-- Android home screen launcher -->\n  <link rel="icon" type="image\/png" sizes="512x512" href="[PLACEHOLDER]"> <!-- TODO: DONE -->\n  <!-- Large PWA launcher\/splash -->\n\n  <!-- Optional: PWA manifest -->\n  <!-- <link rel="manifest" href="\/site.webmanifest">  -->\n  <!-- Defines icons, theme color, display options for PWA -->\n\n  <!-- Optional: Safari pinned tab (macOS) -->\n  <!-- <link rel="mask-icon" href="\/safari-pinned-tab.svg" color="#5bbad5"> -->\n  <!-- Vector icon for pinned tabs on Safari; color applies as tint -->\n\n  <!-- Optional: Theme color for browsers -->\n  <!-- <meta name="theme-color" content="#ffffff"> -->\n  <!-- Sets toolbar color on Android Chrome, Windows, etc. -->\n\n  <!-- ========================================================= -->\n  <!-- OPTIONAL: STRUCTURED DATA (HOMEPAGE)                      -->\n  <!-- ========================================================= -->\n\n  <!-- <script type="application\/ld+json">\n    {\n      "@context": "https:\/\/schema.org",\n      "@type": "WebSite",\n      "name": "",\n      "url": "",\n      "author": {\n        "@type": "Person",\n        "name": ""\n      },\n      "publisher": {\n        "@type": "Organization",\n        "name": "",\n        "logo": {\n          "@type": "ImageObject",\n          "url": ""\n        }\n      },\n      "potentialAction": {\n        "@type": "SearchAction",\n        "target": "https:\/\/yourblog.com\/search?q={search_term_string}",\n        "query-input": "required name=search_term_string"\n      }\n    }\n  <\/script> -->\n  <!-- ========================================================= -->\n  <!-- END OF SEO + SOCIAL METADATA                              -->\n  <!-- ========================================================= -->\n<\/head>|s' index.html && rm index.html.bak
